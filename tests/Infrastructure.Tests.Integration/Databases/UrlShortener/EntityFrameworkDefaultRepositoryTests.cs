...
public class EntityFrameworkDefaultRepositoryTests(MovieReviewsDataFixture fixture)
{
    #region Authors
    ...
    public async Task CreateReview_ShouldReturn_NewReviews()
    {
        ...
        // Act
        var result = await fixture.Repository.CreateReview(
            review.AuthorId,
            review.MovieId,
            review.Stars,
            token
    ...
    public async Task UpdateReview_ShouldReturn_True()
    {
        ...
        // Act
        var result = await fixture.Repository.UpdateReview(
            review.Id,
            review.AuthorId,
            review.MovieId,
            review.Stars,
